...
// NOTE: block order is significant. hero-banner (mapped to .hero-card-container)
// must run BEFORE cards-promo (mapped to the nested .hero-card-row): hero-banner
// re-emits the .hero-card-row as a sibling so cards-promo can then parse it.
const PAGE_TEMPLATE = {
  name: 'homepage',
